            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              {isLoadingPostDetail ? (
                ...
                <>
                  ...
                  <div className="fixed bottom-[226px] w-[90%] lg:w-[751px] rounded-bl-[8px] rounded-br-[8px]  bg-brand-500 flex justify-between items-center fixed h-[98px] border border-brand-2800 border-b-transparent border-x-transparent">
