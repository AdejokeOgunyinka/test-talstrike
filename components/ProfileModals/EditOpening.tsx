...
const EditOpening = ({ onClose, id }: { onClose: () => void; id: string }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: editOpeningValidationSchema,
      ...
      editPost(
        { token: TOKEN as string, body, id },
        {
          onSuccess: () => {
            notify({
              type: "success",
              text: "Opening has been successfully updated!",
            });
                    ...
                    <div className="flex flex-col gap-y-[35px]">
                      ...
                      <div className="w-full">
                        <TextBox
                          ...
                          id="description"
                          placeholder="More details about this opening..."
                        />
                        <ErrorMessage
                          name="description"
                          component="p"
