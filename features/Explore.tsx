...
const Index = () => {
  ...
  return (
    <DashboardLayout>
      <div className="w-full flex flex-col min-h-[100vh] bg-brand-1000 pt-[28px] pb-[28px] overflow-y-scroll">
        <Flex
          width={{
            base: "100%",
            md: "calc(100% - 456px)",
          ...
          className="z-[99] pl-[30px] flex-wrap lg:flex-nowrap gap-y-[10px] lg:-mt-[40px] backdrop-blur-[15px] lg:pt-[25px] lg:fixed lg:top-[79px] gap-x-[20px] lg:gap-x-[54px] mr-[31px] bg-brand-profile-header border-t-0 border-[3px] border-x-0 lg:border-b-brand-300"
        >
